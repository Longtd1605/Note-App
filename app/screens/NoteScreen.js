        ...
        <TouchableWithoutFeedback onPress={handleOutSidePress}>
            <View style={styles.container}>
                <View style={{flexDirection:'row-reverse'}}>
                    <PopupMenu count={handleMess}></PopupMenu>
                </View>
                ...
                <View style={{flexDirection:'row',justifyContent:'flex-end'}}>
                    <Text style={{fontSize:20,fontWeight:'600'}}>Sắp xếp theo thời gian | </Text>
                    <TouchableOpacity onPress={()=>setsortlist(!sortlist)}>
                        <Text style={{fontSize:20,fontWeight:'500'}}>{sortlist?'Mới nhất':'Cũ nhất'}</Text>
                    </TouchableOpacity>
                </View>
                {resultNotFound
                    ? <NotFound/>
                ...
                {!notes.length?
                    <View style={[StyleSheet.absoluteFillObject, styles.emptyHeaderContainer]}>
                        <Text style={styles.emptyHeader}>Thêm ghi chú</Text>
                    </View>:null}
            </View>
